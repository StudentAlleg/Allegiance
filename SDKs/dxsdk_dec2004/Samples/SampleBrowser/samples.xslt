			...
			<td colspan="2" valign="top" height="30" style="padding-left: 22px">
				...
				<xsl:choose>
					<xsl:when test="@onX64[.='yes']">
						...
						<xsl:attribute name="href">results.htm#"..\..\<xsl:value-of select="exefolder"/>x86\<xsl:value-of select="exe"/>"</xsl:attribute>
				...
				<xsl:when test="install">
					<a class="links">
					<xsl:attribute name="href">results.htm#INSTALL:"..\..\<xsl:value-of select="folder"/>
