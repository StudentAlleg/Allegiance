...
technique RenderSceneNoTex
{
    pass P0
    {
        VertexShader = compile vs_1_1 VS_NoTex();
        PixelShader = compile ps_1_1 PS_NoTex();
    }
}
...
technique RenderTerrain
{
    pass P0
    {
        ...
        PixelShader = compile ps_1_1 PS_Terrain();
    }
}
...
technique RenderQuad
{
    ...
    {
        VertexShader = null;
        PixelShader = compile ps_1_1 PS_Quad();
    }
}
...
technique RenderProgressBarBackground
{
    ...
    {
        VertexShader = null;
        PixelShader = compile ps_1_1 PS_BarBackground();
...
technique RenderProgressBar
{
    ...
    {
        VertexShader = null;
        PixelShader = compile ps_1_1 PS_Bar();
        AlphaBlendEnable = true;
        SrcBlend = SrcAlpha;
        DestBlend = InvSrcAlpha;
    }
