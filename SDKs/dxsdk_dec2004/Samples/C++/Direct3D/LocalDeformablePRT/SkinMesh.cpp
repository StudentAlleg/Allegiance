...
HRESULT CAllocateHierarchy::FilterMesh( IDirect3DDevice9* pd3dDevice, ID3DXMesh* pMeshIn, ID3DXMesh** ppMeshOut )
{
    ...
    hr = D3DXComputeTangentFrameEx( pTempMesh, D3DDECLUSAGE_TEXCOORD, 0, D3DX_DEFAULT, 0,
                                    D3DDECLUSAGE_TANGENT, 0, D3DDECLUSAGE_NORMAL, 0,
                                    D3DXTANGENT_CALCULATE_NORMALS, NULL, -1.01f, -1.01f, 
									-1.01f, &pNewMesh, NULL );
	if( FAILED(hr) )
		goto e_Exit;
