...
HRESULT CPRTMesh::LoadLDPRTFromFiles( WCHAR* strLDPRTFile, WCHAR* strShadingNormalsFile )
{
    ...
    V( D3DXLoadPRTBufferFromFile( strLDPRTFile, &pLDPRTBuffer ) );
    ...
    HANDLE hFile = CreateFile( strShadingNormalsFile, GENERIC_READ, 0, NULL, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, NULL );
    if( hFile )
    {
        DWORD dwRead;
