...
COptionsFile::COptionsFile()
{
    ...
    StringCchCopy( m_strFile, MAX_PATH, strExePath );
                ...
                case IDC_PREDEF_COMBO:
                    if( HIWORD(wParam) == CBN_SELCHANGE )
                    {
                        ...
                        if( lResult != CB_ERR )
                        {
                            ...
                            StringCchPrintf( sz, 256, TEXT("%0.4f"), pMat->Absoption.r ); SetDlgItemText( hDlg, IDC_ABSORPTION_R_EDIT, sz ); 
                            StringCchPrintf( sz, 256, TEXT("%0.4f"), pMat->Absoption.g ); SetDlgItemText( hDlg, IDC_ABSORPTION_G_EDIT, sz ); 
                            StringCchPrintf( sz, 256, TEXT("%0.4f"), pMat->Absoption.b ); SetDlgItemText( hDlg, IDC_ABSORPTION_B_EDIT, sz ); 
                    ...
                    if( TRUE == GetOpenFileName( &ofn ) )
                    {
                        ...
                        if( pLastSlash )
                        {
                            *pLastSlash = 0;
                            ...
                            StringCchCopy( GetGlobalOptions().strOutputMesh, MAX_PATH, strResults );
...
void COptionsFile::ResetSettings()
{
    ...
    StringCchCat( m_Options.strInitialDir, MAX_PATH, L"" );
...
void CPRTOptionsDlg::UpdateControlsWithSettings( HWND hDlg )
{
    ...
    StringCchPrintf( sz, 256, TEXT("%0.4f"), GetGlobalOptions().Absoption.r ); sz[255] = 0; SetDlgItemText( hDlg, IDC_ABSORPTION_R_EDIT, sz ); 
    StringCchPrintf( sz, 256, TEXT("%0.4f"), GetGlobalOptions().Absoption.g ); sz[255] = 0; SetDlgItemText( hDlg, IDC_ABSORPTION_G_EDIT, sz ); 
    StringCchPrintf( sz, 256, TEXT("%0.4f"), GetGlobalOptions().Absoption.b ); sz[255] = 0; SetDlgItemText( hDlg, IDC_ABSORPTION_B_EDIT, sz ); 
