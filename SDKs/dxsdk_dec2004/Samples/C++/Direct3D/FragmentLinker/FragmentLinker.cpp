...
HRESULT CALLBACK OnCreateDevice( IDirect3DDevice9* pd3dDevice, const D3DSURFACE_DESC* pBackBufferSurfaceDesc )
{
    ...
    V_RETURN( D3DXCompileShaderFromFile( strPath, NULL, NULL, "ModulateTexture", "ps_1_1", 0, &pCode, NULL, NULL ) );
...
HRESULT LinkVertexShader()
{
    ...
    V_RETURN( g_pFragmentLinker->LinkShader( "vs_1_1", 0, aHandles, NUM_FRAGMENTS, &pCode, NULL ) );
