...
#End Region
    ...
    Private Sub OnCreateDevice(ByVal sender As Object, ByVal e As DeviceEventArgs)
        ...
        Dim shaderFlags As ShaderFlags = shaderFlags.None
    ...
    '/ </summary>
    Private Sub OnKeyEvent(ByVal key As System.Windows.Forms.Keys, ByVal isKeyDown As Boolean, ByVal isKeyUp As Boolean)
        If isKeyDown Then
            Select Case key
    ...
    Shared Function Main() As Integer
        ...
        Try
            ...
            sampleFramework.SetKeyboardCallback(AddressOf sample.OnKeyEvent)
